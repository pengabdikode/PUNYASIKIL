<!-- ========================= FOOTER ========================= -->
<footer class="section-footer bg-warning black">
    <div class="container">
        ...
        <section class="footer-bottom row border-top-white">
            <div class="col-sm-6">
                <p class="text-md-left text-black-50"> Made by
                    <br>SikilTeam</p>
            </div>
            <div class="col-sm-6">
                <p class="text-md-right text-black-50">
                    Copyright &copy SikilTeam 2019
                    <br>
                </p>
            </div>
        </section>
